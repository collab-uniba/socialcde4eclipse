...
public class UI_UnitTestForRegistration extends TestCase {
	...
	public void testCase1() { 
	  ...
	  assertEquals("Please compile all field correctly!", ((Label) dati.get("LabelAlert")).getText()); 
	...
	public void testCase3() { 
	  ...
	  assertTrue( ((Label) dati.get("LabelAlert")).getVisible()); 
	  assertEquals("Please insert the email on which you recived the invite", ((Label) dati.get("LabelAlert")).getText()); 
