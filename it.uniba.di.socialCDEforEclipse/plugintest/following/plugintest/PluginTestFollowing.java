...
public class PluginTestFollowing extends TestCase {
	...
	public void testCase1() {
		...
		if (dati.containsKey("userFollowings")) {
			assertTrue(((ArrayList<Composite>) dati.get("userFollowings"))
					.size() > 0);
		} else {
	...
	public void testCase2() {
		...
		if (dati.containsKey("labelFollowings")) {
			assertEquals("You are following no one.",
					((Label) dati.get("labelFollowings")).getText());
		} else {
		...
		PlatformUI
				...
				.hideView(
						PlatformUI
								...
								.getActivePage()
								.findView(
										"SocialCDEforEclipseIndigoVersion.SocialCDE4Eclipse"));
	}
