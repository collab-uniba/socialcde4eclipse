...
public class PluginTestIterationTimeline extends TestCase {
	...
	@Test public void testCase2()
	{
		...
		assertEquals("There are no older post available.",( (Label) ((Composite)  dati.get("otherPostWarning")).getChildren()[0]).getText());
	...
	@Test public void testCase3()
	{
		...
		if(!Controller.getProxy().Post(Controller.getCurrentUser().Username, Controller.getCurrentUserPassword(), message))
		{
			fail("Post not send"); 
		}
