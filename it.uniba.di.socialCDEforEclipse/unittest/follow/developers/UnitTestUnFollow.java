...
public class UnitTestUnFollow {
	 ...
	 * correct id 2.Unfollow a developer identified by wrong id (-1)
	 * 
	 * Note: For test the equivalence class number 1, the system select a random
	...
	public void testCase1() {
		...
		assertTrue(Controller.getProxy().UnFollow(
				Controller.getCurrentUser().Username,
	...
	public void testCase2() {
		...
		assertFalse(Controller.getProxy().UnFollow(
				Controller.getCurrentUser().Username,
				Controller.getCurrentUserPassword(), -1));
