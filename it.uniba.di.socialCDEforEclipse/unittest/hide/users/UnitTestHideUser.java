...
public class UnitTestHideUser extends TestCase {
	...
	public void testCase1()
	{
		 ...
		 assertTrue(Controller.getProxy().UpdateHiddenUser(Controller.getCurrentUser().Username, Controller.getCurrentUserPassword(), users[positionUser].Id, true, false, false));
	...
	public void testCase2()
	{
		 ...
		 assertTrue(Controller.getProxy().UpdateHiddenUser(Controller.getCurrentUser().Username, Controller.getCurrentUserPassword(), users[positionUser].Id, false, true, false));
	...
	public void testCase3()
	{
		 ...
		 assertTrue(Controller.getProxy().UpdateHiddenUser(Controller.getCurrentUser().Username, Controller.getCurrentUserPassword(), users[positionUser].Id, false, false, true));
	...
	public void testCase4()
	{
		 ...
		 assertFalse(Controller.getProxy().UpdateHiddenUser(Controller.getCurrentUser().Username, Controller.getCurrentUserPassword(), positionUser, false, false, true));
