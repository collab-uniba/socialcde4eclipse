...
public class PinPanel implements Panel {
	...
	public void inizialize(Composite panel) {
		...
		if (service.OAuthVersion == 1) {
			...
			labelVerifierPin.setFont(new Font(Controller.getWindow()
			...
			labelInformation
					.setText("Please authorize the application and click OK before closing the browser");
			gridData = new GridData();
			gridData.horizontalSpan = 2;
		 ...
		 * btnCancel.setText("Cancel"); btnCancel.addPaintListener(new
		 * PaintListener() {
		 * 
		 * @Override public void paintControl(PaintEvent e) { // TODO
		 * Auto-generated method stub Button btn = (Button) e.widget;
