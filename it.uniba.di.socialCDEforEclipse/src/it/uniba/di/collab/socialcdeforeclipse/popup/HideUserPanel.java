...
public class HideUserPanel implements Panel {
	...
	public void inizialize(Composite panel) {
		...
		try {
			labelAvatar.setImage(get_ImageStream(new URL(user_selected.Avatar)
					.openStream()));
		...
		WHidden hiddenSetting = Controller.getProxy().GetUserHideSettings(
	...
	public HashMap<String, Object> getData() {
		...
		uidata.put("interactiveTimelinePermission",
				interactiveTimelinePermission);
