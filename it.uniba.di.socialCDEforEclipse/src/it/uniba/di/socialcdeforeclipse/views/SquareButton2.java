...
public class SquareButton2 extends Canvas {
	...
	public SquareButton2(Composite parent, int style) {
	...
	protected void addListeners() {
		addDisposeListener(new DisposeListener() {
			public void widgetDisposed(DisposeEvent e) {
				SquareButton2.this.widgetDisposed(e);
			}
		});
		...
		addPaintListener(new PaintListener() {
			public void paintControl(PaintEvent e) {
				...
				SquareButton2.this.paintControl(e);
			}
		});
		...
		this.addListener(SWT.MouseEnter, new Listener() {
			public void handleEvent(Event e) {
				SquareButton2.this.setHoverColor(e);
			}
		});
		this.addListener(SWT.MouseExit, new Listener() {
			public void handleEvent(Event e) {
				if (isFocused)
					SquareButton2.this.setSelectedColor(e);
				else
					SquareButton2.this.setNormalColor(e);
			}
		});
		...
		this.addListener(SWT.MouseDown, new Listener() {
			public void handleEvent(Event e) {
				if (e.button == 1) {
					SquareButton2.this.setClickedColor(e);
				}
			}
		});
