...
public class DynamicHomeTimeline implements Panel {
	...
	public void inizialize(Composite panel) {
		...
		/*
		 * gridData = new GridData(); gridData.widthHint =
		 * Controller.getWindowWidth(); gridData.heightHint =
		 * (Controller.getWindowHeight() -
		 * Controller.getProfilePanel().getComposite_static
		 * ().getBounds().height) + 100; System.out.println("Totale scelto " +
		 * (Controller.getWindowHeight() -
		 * Controller.getProfilePanel().getComposite_static
		 * ().getBounds().height)); panel.setLayoutData(gridData);
		 */

		// Controller.setScrollHeight(Controller.getWindowHeight() + 100);
		// ((ScrolledComposite)
		// Controller.getWindow().getParent()).setMinSize(Controller.getWindowWidth(),
		// SWT.DEFAULT);
		...
		superUserPostMaster.addControlListener(new ControlAdapter() {
			public void controlResized(ControlEvent e) {
				...
				superUserPostMaster.setMinSize(
						Controller.getWindowWidth() - 10, (110 * posts.length));
		...
		superUserPostMaster.setMinSize(Controller.getWindowWidth() - 10,
				(110 * posts.length));
		...
		panel.addPaintListener(new PaintListener() {
			...
			public void paintControl(PaintEvent e) {
				...
				// superUserPostMaster.setBounds(Controller.getWindow().computeTrim(0,
				// 0, Controller.getWindowWidth()-10, 400));
				// e.height = Controller.getWindow().getBounds().height -
				// Controller.getProfilePanel().getComposite_static().getBounds().height;
				...
				// try1.setBounds(Controller.getWindow().computeTrim(5,
				// superUserPostMaster.getClientArea().height + 150, 542, 20));

				// System.out.println("Dimen post " +
				// controlToPost.getBounds());
		 ...
		 * GridData.FILL;
		 * 
		 * Controller.getProfilePanel().getComposite_dinamic().setLayoutData(
		 * gridData);
