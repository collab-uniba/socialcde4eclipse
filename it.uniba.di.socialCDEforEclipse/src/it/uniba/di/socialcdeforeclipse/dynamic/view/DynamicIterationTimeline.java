...
public class DynamicIterationTimeline implements Panel {
	...
	public void inizialize(Composite panel) {
		...
		// textMessage.setBackgroundImage(
		// resize(get_ImageStream(this.getClass().getClassLoader().getResourceAsStream("images/baloon.png")),
		// Controller.getWindowWidth() - 95, 75));
