...
public interface ISocialTFSProxy {
	 ...
	 * @return True if the username is not already assigned to another user, false otherwise.
	 * */
	 ...
	 * and returns a JSON response.
	 * 
	 * @param email Email address to which the invitation was sent.
	 * @param password Password sent in the invitation.
	 * @param username New username chosen by the user.
	 * @return 0 if subscription is successful,1 if e-mail address does not exist in the database,2 if password does not match with the e-mail address sent,3 if username is already used by another user.
	 * */
	 ...
	 * @param username Name that identifies the user.
	 * @param password Password to check user identity.
	 * @param colleagueId The id of the colleague.
	 * @return The profile of the user.
	 * */
	 ...
	 * @param username Name that identifies the user.
	 * @param password Password to check user identity.
	 * @param since Id of last downloaded post.
	 * @param to Id of first downloaded post.
	 ...
	 * @param username Name that identifies the user.
	 * @param password Password to check user identity.
	 * @param ownerName The owner of the timeline.
	 * @param since Id of last downloaded post.
	 * @param to Id of first downloaded post.
	 ...
	 * @param username Name that identifies the user.
	 * @param password Password to check user identity.
	 * @param collection Collection in which to try the interactive object reference.
	 * @param interactiveObject The interactive object around which to create the network.
	 * @param interactiveObject Array of all interacrive objects within user workspace.
	 * @param since Id of last downloaded post.
	 * @param to Id of first downloaded post.
	...
	/**
	 * Returns the friends of the user that are in the same time in SocialCde and in an active microblog.
	 * <p>
	 ...
	 *  @param username Name that identifies the user.
	 *  @param password Password to check user identity.
	 *  @param ownerName The owner of the skills.
	 *  @return A list of suggested friends.
	 * */
	 ...
	 * @param username Name that identifies the user.
	 * @param password Password to check user identity.
	 * @param user User that current user want to get the visibility.
