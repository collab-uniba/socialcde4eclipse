...
public class RegistrationPanel implements Panel {
	...
	public void inizialize(Composite panel) {
		...
		btnRegister.setData("LabelImageInvitationCode",
				labelImageInvitationCode);
		...
		txtProxyHost.setData("LabelImageInvitationCode",
				labelImageInvitationCode);
		...
		txtUsername.setData("LabelImageInvitationCode",
				labelImageInvitationCode);
